...
class CadastroGuarnicaoSentinela3 extends StatefulWidget {
  final String? Name;
  String? nome;
  ...
  @override
  State<CadastroGuarnicaoSentinela3> createState() => _MyStatefulWidgetState();
}

class _MyStatefulWidgetState extends State<CadastroGuarnicaoSentinela3> {
