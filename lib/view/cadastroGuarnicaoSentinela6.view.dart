...
class CadastroGuarnicaoSentinela6 extends StatefulWidget {
  final String? Name;
  String? nome;
  ...
  @override
  State<CadastroGuarnicaoSentinela6> createState() => _MyStatefulWidgetState();
}

class _MyStatefulWidgetState extends State<CadastroGuarnicaoSentinela6> {
