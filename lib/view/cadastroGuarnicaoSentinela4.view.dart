...
class CadastroGuarnicaoSentinela4 extends StatefulWidget {
  final String? Name;
  String? nome;
  ...
  @override
  State<CadastroGuarnicaoSentinela4> createState() => _MyStatefulWidgetState();
}

class _MyStatefulWidgetState extends State<CadastroGuarnicaoSentinela4> {
