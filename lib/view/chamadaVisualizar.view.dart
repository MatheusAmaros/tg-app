                ...
                child: Theme(
                  ...
                  builder: (_, snapshot){
                    ...
                    if(snapshot.data!.docs.length == 0){
                      return Center(child: Text("Sem chamada cadastrada.",  style: TextStyle(color: Colors.grey.shade900, fontFamily: 'Montserrat', fontSize: 17 ),));
                    }

                    return Column(
                      children:[
                        Container(padding: EdgeInsets.fromLTRB(0, 35, 0, 0),),
                        Text("Pelotão $numPelotao - $dataText", style: TextStyle(color: Colors.grey.shade900, fontFamily: 'Montserrat-S', fontSize: 15 ),),
                        ListView.builder( 
                          ...
                          itemBuilder: (_, index){
                            return CheckboxListTile(
                              title: Text(snapshot.data!.docs[index]['nome'], style: TextStyle(color: Colors.grey.shade900, fontFamily: 'Montserrat',)),
