...
class ChamadaPelotaoVisualizarView extends StatefulWidget {
  @override
  State<ChamadaPelotaoVisualizarView> createState() =>
      _chamadaPelotaoVisualizarViewState();
}

class _chamadaPelotaoVisualizarViewState
    extends State<ChamadaPelotaoVisualizarView> {
  List<DropdownMenuItem<String>> get dropdownItemsPelotao {
    List<DropdownMenuItem<String>> menuItems = [
      DropdownMenuItem(
          child: Text("Pelotão 1",
              style: TextStyle(
                                  ...
                                  DateTime? datePicker = await showDatePicker(
                                      ...
                                      builder: (context, child) => Theme(
                                          data: ThemeData().copyWith(
                                            ...
                                            primary:
                                                Color.fromARGB(255, 0, 34, 2),
                                            onPrimary: Colors.white,
                                          )),
                                          child: child!));
                                  if (datePicker != null) {
                                    setState(() {
                                      dataInicial = DateFormat("yyyy-MM-dd")
                                          .format(datePicker)
                                          .toString();
                                      dataText = DateFormat("dd/MM/yyyy")
                                          .format(datePicker)
                                          .toString();
                                    });
                                  }
                          ...
                          child: Row(
                              ...
                              children: [
                                ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Navigator.of(context).pushNamed('/chamadaV',
                                        arguments: {
                                          'pelotao': pelotao,
                                          'dataText': dataText,
                                          'dataInv': dataInicial
