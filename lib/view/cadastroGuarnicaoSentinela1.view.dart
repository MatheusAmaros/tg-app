...
class CadastroGuarnicaoSentinela1 extends StatefulWidget {
  final String? Name;
  String? nome;
  ...
  @override
  State<CadastroGuarnicaoSentinela1> createState() => _MyStatefulWidgetState();
}

class _MyStatefulWidgetState extends State<CadastroGuarnicaoSentinela1> {
