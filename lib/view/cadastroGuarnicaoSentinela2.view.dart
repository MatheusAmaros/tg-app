...
class CadastroGuarnicaoSentinela2 extends StatefulWidget {
  final String? Name;
  String? nome;
  ...
  @override
  State<CadastroGuarnicaoSentinela2> createState() => _MyStatefulWidgetState();
}

class _MyStatefulWidgetState extends State<CadastroGuarnicaoSentinela2> {
